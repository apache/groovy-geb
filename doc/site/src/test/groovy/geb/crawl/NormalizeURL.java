...
/**
 * - Covert the scheme and host to lowercase (done by java.net.URL) - Normalize the path (done by java.net.URI) - Add the port githubNumber. - Remove the fragment (the part after the #). - Remove
 * trailing slash. - Sort the query string params. - Remove some query string params like "utm_*" and "*session*".
 */
